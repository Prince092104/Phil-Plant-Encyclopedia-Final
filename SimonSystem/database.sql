...
VALUES (
        ...
        'Sampaguita',
        'Jasminum sambac',
        'The national flower of the Philippines with fragrant white blossoms.',
        'Grows in home gardens, parks, and roadside hedges in Metro Manila.',
        'Used in leis, perfume, and religious offerings.',
        'Not currently endangered but highly valued in cultural traditions.'
    );
...
VALUES (
        ...
        'Benguet pine',
        'Pinus kesiya',
        'Pine tree typically found in the highland forests of northern Luzon.',
        'Prefers cool mountain slopes and forested highlands around Baguio.',
        'Used for timber, landscaping, and erosion control.',
        'Maintains stable populations in its native highlands.'
    );
...
VALUES (
        ...
        'A popular flowering shrub with large colorful blooms seen across Cebu City.',
        'Found in urban gardens, schools, and parks.',
        'Used as an ornamental and in traditional herbal preparations.',
        'Commonly cultivated and not endangered.'
    );
...
VALUES (
        ...
        'Waling-waling',
        'Vanda sanderiana',
        'A rare and iconic Philippine orchid native to Davao Region.',
        'Grows in lowland and montane forests near Davao City.',
        'Highly prized as an ornamental flower and cultural icon.',
        'Endangered in the wild due to habitat loss and collection pressure.'
    );
...
VALUES (
        ...
        'Ylang-ylang',
        'Cananga odorata',
        'A fragrant tree cultivated in Puerto Princesa and Palawan.',
        'Thrives in tropical lowland gardens and estate groves.',
        'Used to extract essential oil for perfume and aromatherapy.',
        'Not endangered, but best grown sustainably in protected areas.'
    );
...
VALUES (
        ...
        'Nipa palm',
        'Nypa fruticans',
        'A mangrove palm common in coastal estuaries near Zamboanga City.',
        'Thrives in brackish water swamps and tidal river mouths.',
        'Used for nipa shingles, sugar, and traditional crafts.',
        'Locally abundant where mangrove habitat remains healthy.'
    );
...
VALUES (
        ...
        'Cacao',
        'Theobroma cacao',
        'A fruit tree cultivated in General Santos and nearby southern Mindanao areas.',
        'Grows in humid lowland farms and agroforestry plantations.',
        'Produces cocoa beans used for chocolate and local specialties.',
        'Cultivated widely, with sustainable farming improving long-term prospects.'
    );